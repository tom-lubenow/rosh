  ...
  internal = rec {
    ...
    crates = {
      ...
      "termwiz" = rec {
        ...
        version = "0.22.0";
        edition = "2018";
        sha256 = "1laiwns3l16ilnpxysrm0i6afymrncsj0h1ix8348pfs44z32xas";
        authors = [
          "Wez Furlong"
        ];
        dependencies = [
        ...
        features = {
          ...
          "use_serde" = [
            "serde"
            "wezterm-color-types/use_serde"
            "wezterm-blob-leases/serde"
            "bitflags/serde"
            "wezterm-input-types/serde"
          ];
          "widgets" = [
            "cassowary"
            "fnv"
      ...
      "tokio" = rec {
        ...
        dependencies = [
          ...
          }
          {
            ...
            usesDefaultFeatures = false;
            target =
              { target, features }: ((target."tokio_uring" or false) && ("linux" == target."os" or null));
          }
          {
            name = "libc";
            packageId = "libc";
